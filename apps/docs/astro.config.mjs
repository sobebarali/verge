...
export default defineConfig({
	integrations: [
		starlight({
			...
			social: [
				{ icon: 'github', label: 'GitHub', href: 'https://github.com/your-org/verge' }
			],
			sidebar: [
				{
				...
				},
				{
					...
					items: [
						...
						{ label: 'Monorepo Structure', slug: 'architecture/monorepo-structure' },
						{ label: 'Data Flow', slug: 'architecture/data-flow' },
						{ label: 'Technology Decisions', slug: 'architecture/technology-decisions' },
					],
				},
				{
					label: 'API Reference',
					items: [
							...
							items: [
								...
								{ label: 'Procedures', slug: 'api/trpc/procedures' },
								{
									...
									items: [
										...
										{ label: 'healthCheck', slug: 'api/trpc/routers/health-check' },
										{ label: 'privateData', slug: 'api/trpc/routers/private-data' },
									],
								},
							],
						},
						{
							...
							items: [
								...
								{ label: 'Email & Password', slug: 'api/authentication/email-password' },
								{ label: 'Session Management', slug: 'api/authentication/session-management' },
								{ label: 'Client Integration', slug: 'api/authentication/client-integration' },
							],
						},
						{
							label: 'Payments',
							...
							items: [
								...
								{ label: 'Customer Portal', slug: 'api/payments/customer-portal' },
							],
						},
						{
				...
				},
				{
					...
					items: [
						...
						{ label: 'Adding a tRPC Endpoint', slug: 'guides/adding-a-trpc-endpoint' },
						{ label: 'Adding a Database Model', slug: 'guides/adding-a-database-model' },
						{ label: 'Adding Authentication', slug: 'guides/adding-authentication' },
				...
				},
				{
					...
					items: [
						...
						{ label: 'Google Sheets Integration', slug: 'roadmap/google-sheets-integration' },
